...
import com.msitko.employeemanager.controllers.EmployeeConsoleController;
...
/**
 * Class is used to presenting information about Employee in console
 * 
 * @author Marcin Sitko
 * @version 1.0
 * 
 */
public class EmployeeConsoleView extends EventSource {
	...
	public void editEmployeeEvent() {
		fireEvent(new ActionEvent(this, EmployeeConsoleController.MenuOptions.EDIT_EMPLOYEE.getValueOf(), null));
		displayMenuEvent();
	}
	...
	public void addEmployeeEvent() {
		...
		fireEvent(new ActionEvent(this, EmployeeConsoleController.MenuOptions.ADD_EMPLOYEE.getValueOf(), null));
		displayMenuEvent();
	}
	...
	public void deleteEmployeeEvent() {
		fireEvent(new ActionEvent(this, EmployeeConsoleController.MenuOptions.DELETE_EMPLOYEE.getValueOf(), null));
		displayMenuEvent();
	}
	...
	public void displayEmployeesEvent() {
		fireEvent(new ActionEvent(this, EmployeeConsoleController.MenuOptions.DISPLAY_EMPLOYEE.getValueOf(), null));
		displayMenuEvent();
	}
	...
	public void displayMenuEvent() {
		fireEvent(new ActionEvent(this, EmployeeConsoleController.MenuOptions.DISPLAY_MENU.getValueOf(), null));
	}
	...
	public void exitAppEvent() {
		fireEvent(new ActionEvent(this, EmployeeConsoleController.MenuOptions.EXIT_APP.getValueOf(), null));
	}
}
